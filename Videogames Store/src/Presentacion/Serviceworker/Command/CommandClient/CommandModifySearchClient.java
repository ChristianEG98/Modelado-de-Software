...
*/
public class CommandModifySearchClient implements Command {
	/** 
	* (non-Javadoc)
	...
	*/
	public Context execute(Object fact) {
		...
		if(tClient != null) return new Context(Events.MODIFY_SEARCH_CLIENT_OK, tClient);
		else return new Context(Events.MODIFY_SEARCH_CLIENT_KO, tClient);
	}
}